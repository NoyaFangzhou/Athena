...
extension SignInViewController {
    ...
    func handleUserPoolSignUp () {
        print("handleuserpoolsignup\n")
        let storyboard = UIStoryboard(name: "UserPools", bundle: Bundle.main)
        let viewController : UIViewController = storyboard.instantiateViewController(withIdentifier: "SignUp") as UIViewController
        present(viewController, animated: true, completion: nil);
        print("pushed\n")
    }
    
    func topMostController() -> UIViewController {
        print("topMostController is called\n")
    ...
    func handleUserPoolForgotPassword () {
        print("handleUserPoolForgotPassword\n")
...
extension SignInViewController: AWSCognitoUserPoolsSignInHandler {
    func handleUserPoolSignInFlowStart() {
        ...
        guard let username = self.usrname, !username.isEmpty,
            let password = self.pwd, !password.isEmpty else {
                DispatchQueue.main.async(execute: {
